...
import styles from './NewArrowSpeedometer.module.scss'
...
const NewArrowSpeedometer = memo(({progress}: SpeedometerArrowProps) => {
...
NewArrowSpeedometer.displayName = 'SpeedometerArrow'

export default NewArrowSpeedometer;