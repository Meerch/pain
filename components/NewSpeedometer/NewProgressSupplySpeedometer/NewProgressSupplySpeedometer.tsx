...
import styles from "./NewProgressSupplySpeedometer.module.scss";
...
const NewProgressSupplySpeedometer = memo(() => {
...
NewProgressSupplySpeedometer.displayName = 'SpeedometerProgressSupply'

export default NewProgressSupplySpeedometer;
